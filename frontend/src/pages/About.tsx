...
const About = () => {
  const stats = [
    { icon: faCar, number: '2,500+', label: 'Premium Vehicles', color: 'text-primary-500' },
    { icon: faUsers, number: '15,000+', label: 'Happy Customers', color: 'text-primary-600' },
    { icon: faCalendarAlt, number: '8', label: 'Years Experience', color: 'text-primary-700' },
    { icon: faStar, number: '4.9/5', label: 'Customer Rating', color: 'text-primary-500' }
  ];
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-neutral-900">
        ...
        <div className="relative container mx-auto px-4 py-24 lg:py-32">
          <div className="max-w-4xl mx-auto text-center text-white">
            <h1 className="text-5xl lg:text-7xl font-bold mb-8 leading-tight">
              Redefining <span className="text-primary-200">Mobility</span>
            </h1>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <div className="bg-white/10 backdrop-blur-sm px-6 py-3 rounded-full">
                <span className="text-primary-100 font-semibold">✨ Premium Fleet</span>
              </div>
              <div className="bg-white/10 backdrop-blur-sm px-6 py-3 rounded-full">
                <span className="text-primary-100 font-semibold">🛡️ Fully Insured</span>
              </div>
              <div className="bg-white/10 backdrop-blur-sm px-6 py-3 rounded-full">
                <span className="text-primary-100 font-semibold">🚀 Instant Booking</span>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                <h2 className="text-4xl lg:text-5xl font-bold mb-8 text-neutral-900 dark:text-white leading-tight">
                  Our <span className="text-primary-600">Journey</span> Started with a Simple Belief
                </h2>
                <div className="space-y-6 text-lg text-neutral-600 dark:text-neutral-300 leading-relaxed">
                  ...
                  <p>
                    ...
                    We've helped over <strong className="text-primary-600">15,000 customers</strong> create unforgettable memories, 
              ...
              <div className="relative">
                <div className="bg-gradient-to-br from-primary-100 to-primary-200 dark:from-primary-900/20 dark:to-primary-800/20 rounded-3xl p-8 h-96 flex items-center justify-center">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-16">
              <div className="bg-white dark:bg-neutral-700 rounded-3xl p-10 shadow-lg hover:shadow-xl transition-shadow">
                <div className="flex items-center mb-6">
                  <div className="bg-primary-100 dark:bg-primary-900/30 p-4 rounded-2xl mr-4">
                    <FontAwesomeIcon icon={faRocket} className="text-3xl text-primary-600" />
                  </div>
              ...
              <div className="bg-white dark:bg-neutral-700 rounded-3xl p-10 shadow-lg hover:shadow-xl transition-shadow">
                <div className="flex items-center mb-6">
                  <div className="bg-primary-100 dark:bg-primary-900/30 p-4 rounded-2xl mr-4">
                    <FontAwesomeIcon icon={faGlobe} className="text-3xl text-primary-600" />
                  </div>
      ...
      <div className="py-20 lg:py-28 bg-gradient-to-r from-primary-600 to-primary-700">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold text-white mb-6">
              Trusted by <span className="text-primary-100">Thousands</span>
            </h2>
      ...
      <div className="py-20 lg:py-28">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="bg-gradient-to-br from-primary-50 to-primary-100 dark:from-primary-900/20 dark:to-primary-800/20 rounded-3xl p-8 hover:shadow-lg transition-all duration-300">
      ...
      <div className="py-20 bg-neutral-900">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl lg:text-5xl font-bold text-white mb-6">
            Ready to Start Your <span className="text-primary-100">Journey?</span>
          </h2>
          <p className="text-xl text-neutral-300 mb-8 max-w-2xl mx-auto">
            Join thousands of satisfied customers who trust RentOrbits for their mobility needs
          </p>
          <button className="bg-gradient-to-r from-primary-600 to-primary-700 text-white px-8 py-4 rounded-full text-lg font-semibold hover:shadow-lg transition-all duration-300 hover:scale-105">
            Explore Our Fleet
          </button>
        </div>
      </div>
